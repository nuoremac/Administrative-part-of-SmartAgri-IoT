          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-gray-600 px-3 py-2 text-gray-400 outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••"
                  className="w-full rounded-md border border-gray-200 px-3 py-2 pr-10 text-gray-400 outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200"
                  required
                />
